...
public class CanBoCongNhanVien implements Comparable<CanBoCongNhanVien>{
    ...
    @Override
    public int compareTo(CanBoCongNhanVien o) {
        if((this.luongChinh + this.phuCapChuVu) < (o.luongChinh + o.phuCapChuVu)) return 1;
        else{
            if ((this.luongChinh + this.phuCapChuVu) == (o.luongChinh + o.phuCapChuVu))
